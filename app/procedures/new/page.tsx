      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g. 30 day notice of cancellation"
        ...
        <div>
          ...
          <input
            value={akaTerms}
            onChange={(e) => setAkaTerms(e.target.value)}
            placeholder="e.g. NOC, non-renewal, cancellation letter"
            className="w-full border border-line rounded px-3 py-2 text-sm bg-white"
          />
          <p className="text-xs text-ink-soft mt-1">
            Other words a coworker might search for instead of the title.
          </p>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border border-line rounded p-4 text-sm bg-white leading-relaxed"
          />
        </div>
